package com.unit.composetut.ui.theme.groceryapp
...
import com.unit.composetut.ui.theme.GroceryAppTheme
...
fun Promotions() {
    LazyRow(
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.img_profile),
                title = "Fruit",
                subtitle = "Start @",
                header = "$1",
